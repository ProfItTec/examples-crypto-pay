...
│            │    Выбор: 1000 RUB → USDT на Tron                              │
│            │    user_id обязателен                                          │
│            ▼                                                                │
│   ┌──────────────────┐                                                      │
│   │                  │  2. POST /api/payments/checkout-url                  │
│   │    ФРОНТЕНД      │     { user_id, fiat_amount: 1000,                    │
│   │    МЕРЧАНТА      │       fiat_currency: "RUB",                          │
...
// Hosted Checkout
{ user_id: 'user-123', fiat_amount: 1000, fiat_currency: 'RUB', currency: 'USDT', network: 'tron' }
```
...
{ 
  ...
  fiat_amount: 1000,        // Оригинал в фиате (если был)
  fiat_currency: 'RUB'
}
